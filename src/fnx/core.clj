...
;;
;; I would like to share those snippets of functionnalities to my
;; fellow co-workers, problem is: They may even not know what Clojure
;;is.
;;
;; So what I would like to do: Just write my function to get the job
;; done, but because I put my function in a particular namespace,
